...
\fhaTable[fhaSystemKeyValue=
	     ...
	     fhaNumberKeyValue=
	     	1.2,
	     fhaCausesKeyValue=
	     	{e.g. approaching to low/left/right relative to patient, present turbulence, recirculation, etc.},
	     fhaDescriptionKeyValue=
	     	{During the positioning of the rescuer relative to the patient abrasive contact between \\ longline and highline is possible. 
	     ...
	     fhaMitigationKeyValue=
	     	...
	     	\tabitem abrasion-resistant tubing around highline and backup \\
	     	\tabitem Highline with abrasion-resistant ropes as backup \\
	     	\tabitem Canceling the rescue mission if the pilot or rescuer have concerns
	     	},
	     fhaCritPostKeyValue=
	     	{\textcolor{orange}{medium}, as the tubing prevents abrasion of main line and backup. \\
	     	 With ropes as backups, it is less prone to damage from hitting objects. \\ 
...
\fhaTable[fhaSystemKeyValue=
	     ...
	     fhaCritPostKeyValue=
	     	{\textcolor{orange}{medium}, as the approach to the patient is similar to other maneuvers. \\
...
\fhaTable[fhaSystemKeyValue=
	     ...
	     fhaNumberKeyValue=
	     	1.4,
	     fhaCausesKeyValue=
	     	{\textcolor{teal}{Rescuer} and \textcolor{purple}{patient} are in contact, wake of rotorcraft causes twisting of rescuer and patient.\\
	     ...
	     fhaDescriptionKeyValue=
	     	{During the contact of \textcolor{teal}{rescuer} and \textcolor{purple}{patient}, a unwanted twist of leash and longline could end in\\
	     	 ...
	     	 Furthermore, the twisted ropes can prevent further rappelling or lifting of the rescuer\\
	     ...
	     fhaCritPostKeyValue=
	     	{\textcolor{orange}{medium}, as the patient can intervene and push leash and longline apart which prevents the twisting.
	     	}
	     	]
