...
\fhaTable[fhaSystemKeyValue=
	     ...
	     fhaCritPostKeyValue=
	     	{\textcolor{orange}{medium}. Very unlikely if the anchors are cleaned sufficiently and the staff at the anchors behave accordingly. In addition, the pilot can be prepared}]
...
\fhaTable[fhaSystemKeyValue=
	     ...
	     fhaMitigationKeyValue=
	     	...
	     	\tabitem Prohibit actions near the highline that involve throwing/kicking off objects/etc.},
	     fhaCritPostKeyValue=
	     	{\textcolor{green}{low}. Very unlikely if the anchors are cleaned sufficiently and the staff at the stands behave accordingly.
