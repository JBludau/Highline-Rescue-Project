...
\fhaTable[fhaSystemKeyValue=
	     ...
	     fhaDescriptionKeyValue=
	     	{Before attaching the sling, this is described in 1.1. After attaching the sling (helicopter tied up), the rescuer's load can also be transferred tothe highline via the sling, \textcolor{purple}{patient} harness and leash if the helicopter accidentally loses altitude.
...
\fhaTable[fhaSystemKeyValue=
	     ...
	     fhaDescriptionKeyValue=
	     	{During the attachment, various readjustments of the position of the air \textcolor{teal}{rescuer} may be necessary in order to attach the \textcolor{purple}{patient}.
	      	...
	      	Furthermore, the patient's harness may be attached incorrectly due to the lack of visibility on the patient's harness/leahs/line/etc. }, 
	     fhaMitigationKeyValue=
...
\fhaTable[fhaSystemKeyValue=
	     ...
	     fhaDescriptionKeyValue=
	     	{A falling stone, branch, carabiner, etc. is enough to cut the line under tension.
	      	...
	      	The fall height is limited by the length of the connection between the rope and the patient harness}, 
	     fhaMitigationKeyValue=
	     	{\tabitem Cleaning the anchors of loose stones and objects that could be thrown up \\
...
\fhaTable[fhaSystemKeyValue=
	     ...
	     fhaCausesKeyValue=
	     	{(Temporary) performance deficit of the helicopter}, 
	     fhaDescriptionKeyValue=
	     	{After attaching the sling (helicopter tied up), the rescuer's load can also be transferred to the highline via the sling, patient harness and leash if the helicopter accidentally loses altitude.
...
\clearpage
The flight rescuer's function of "hooking the patient harness into the rope" is no longer relevant in this and all subsequent
...
\fhaTable[fhaSystemKeyValue=
	     ...
	     fhaMitigationKeyValue=
	     {In phase 2: Hook the sling into the leash's attachment loop and into the patient harness's attachment ring.
...
\begin{longtable}{|p{4cm}|p{4cm}|p{4cm}|p{4cm}|p{4cm}|}
 ...
 2. Hanging the patient in cross-cut loop & Leash is shorter than usual, backup loops Highline are not fixed & Secure attachment of the patient harness in sling, Rope hygiene between rope, highline and leash &  Check if the sling is correctly in your harness hung, ensures that the phases are adhered to and warns FR in case of errors. If not released, intervenes by flight \textcolor{teal}{rescuer} & Monitored helicopter position relative to Highline, Warns in case of errors, gives external assessment about termination \\
  \hline
...
4. Cutting the leash (connection of climbing harness to highline & The structure of the leash is modified to include short residence time in this phase. After cutting, the connection can be reestablished by means of a selfbelay loop on the patient (if highline is accessible). In case of failure/loss of a pair of scissors, the \textcolor{purple}{patient} is also covered by a equipped & Disconnects the patient harness from the highline in the neutral position of the highline. Checks before cutting whether there is an unwanted connection or rescue equipment is caught on the highline. & Monitors whether FR only cuts the leash at the neutral point of the highline. Checks before cutting whether there is an unwanted connection or Rescue equipment is attached to the highline. Holds a second pair of scissors and self-protection ready & Monitors whether FR only cuts the leash at the neutral point of the highline. Checks before cutting whether there is an unwanted connection or Rescue equipment is attached to the highline.\\
  \hline
